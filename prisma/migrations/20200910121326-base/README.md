# Migration `20200910121326-base`

This migration has been generated by Farid Esquivel <jovannyrch@gmail.com> at 9/10/2020, 7:13:26 AM.
...
ALTER TABLE `bell_db`.`invitation` ADD FOREIGN KEY (`groupId`) REFERENCES `bell_db`.`group`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
